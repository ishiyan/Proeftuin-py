...
class RunTradeAggregator(TradeAggregator):
    ...
    def __init__(self,
        ...
        if not isinstance(method, str) or method not in \
            RunTradeAggregator.FramingMethods:
    ...
    def aggregate(self, trades: Sequence[Trade]) -> Tuple[Frame, None]:
        result = None
        trade = trades[-1]
        frame = self.frame
        ...
        # Update average values from the trade.
        ...
        # Update the number of processed trades.
        self.n_trades += 1
        return result
