...
from env import Env02, CsvFileLogger, RecordAnimatedGIF, BuySellHoldCloseAction
...
def _create_envs02(
    ...
    return [lambda i=i: _create_env02(
        vec_env_index=i,
        symbol=symbol,
        episode_max_steps=episode_max_steps,
        name=name,
...
def create_vec_env02(
    ...
    if vec_env == 'subproc':
        env = SubprocVecEnv(_create_envs02(
            symbol=symbol,
            episode_max_steps=episode_max_steps,
            name=name,
            dir=original_dir,
        ...
        env = DummyVecEnv(_create_envs02(
            symbol=symbol,
            episode_max_steps=episode_max_steps,
            name=name,
            dir=original_dir,
